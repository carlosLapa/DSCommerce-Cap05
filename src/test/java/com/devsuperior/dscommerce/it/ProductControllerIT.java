...
public class ProductControllerIT {
    ...
    void setUp() throws Exception {
        ...
        product = new Product(null, "Console Playstation 5", "Lorem ipsum, dolot sit amet consectetur adipiscing elit", 3990.90, "https://raw.githubusercontent.com/devsuperior/dscatalog-resources/master/backend/img/1-big.jpg");
    ...
    @Test
    void updateShouldReturnUnprocessableEntityWhenIdExistsAndAdminLoggedAndInvalidName() throws Exception {
    ...
    @Test
    void updateShouldReturnUnprocessableEntityWhenIdExistsAndAdminLoggedAndInvalidDescription() throws Exception {
        product.setDescription("ab");
        productDTO = new ProductDTO(product);
    ...
    @Test
    void updateShouldReturnUnprocessableEntityWhenIdExistsAndAdminLoggedAndPriceIsNegative() throws Exception {
    ...
    @Test
    void updateShouldReturnUnprocessableEntityWhenIdExistsAndAdminLoggedAndPriceIsZero() throws Exception {
        product.setPrice(0.0);
        productDTO = new ProductDTO(product);
    ...
    @Test
    void updateShouldReturnUnprocessableEntityWhenIdExistsAndAdminLoggedAndProductHasNoCategory() throws Exception {
        product.getCategories().clear();
        productDTO = new ProductDTO(product);
    ...
    @Test
    void updateShouldReturnForbiddenWhenIdExistsAndClientLogged() throws Exception {
    ...
    @Test
    void updateShouldReturnUnauthorizedWhenIdExistsAndInvalidToken() throws Exception {
